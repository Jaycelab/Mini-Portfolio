    ...
    <header className='fixed z-50 w-full bg-primary py-6 xl:py-8'>
      <div className='container mx-auto flex items-center justify-between'>
        ...
        <Link to='/' spy={true} smooth={true} className='cursor-pointer'>
          <Image src='/logo.png' height={84.53} width={71.35} alt='logo' />
        </Link>
        {/* desktop nav */}
        <div className='hidden items-center gap-x-8 xl:flex'>
          ...
          <Link
            ...
            spy={true}
            smooth={true}
            className='text-md hover:bg-blue/80 cursor-pointer rounded-full bg-accent px-6 py-2 font-medium text-white transition-all'
          >
            Let's Connect
          </Link>
        </div>
